...
public class GoogleTest {
	...
	// The base URL for a user's calendar metafeed (needs a username appended).
	  ...
	  /*  if (args.length != 2) {
	    ...
	    String userName = "mpigate.loria@gmail.com";
	    String userPassword = "inrianancy";
	    ...
	    try {
	      ...
	      dateRangeQuery(myService, DateTime.parseDate("2012-10-30"), DateTime
	          .parseDate("2007-10-31"));
