package fr.inria.phoenix.diasuite.framework.distributed.localstorage;
 ...
 * }
 */
public abstract class AbstractLocalStorage extends Service {

    public AbstractLocalStorage(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user, java.lang.String name) {
      super("/Device/Device/PhysicalDevice/Storage/LocalStorage/", serviceConfiguration);
      updateId(id);
