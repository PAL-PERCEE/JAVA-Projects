 ...
 * }
 */
public abstract class AbstractPrompter extends Service {

    public AbstractPrompter(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Prompter/", serviceConfiguration);
      updateId(id);
