package fr.inria.phoenix.diasuite.framework.distributed.prompter;
...
public final class AnswerFromPrompter implements Serializable {
  ...
  public AnswerFromPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, AnswerIndices indices) {
    this.sender = new PrompterProxy(service, remoteServiceInfo);
    this.value = value;
    this.indices = indices;
  }
  
  public AnswerFromPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, java.lang.String questionId) {
    this.sender = new PrompterProxy(service, remoteServiceInfo);
    this.value = value;
  ...
  public AnswerIndices indices(){
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      AnswerFromPrompter other = (AnswerFromPrompter) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private PrompterProxy sender;
  
  public PrompterProxy sender() {
    return sender;
  }

  public class PrompterProxy extends Proxy {
