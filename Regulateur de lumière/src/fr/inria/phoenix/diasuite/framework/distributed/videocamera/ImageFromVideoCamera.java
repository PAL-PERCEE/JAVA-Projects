...
public final class ImageFromVideoCamera implements Serializable {
  ...
  public ImageFromVideoCamera(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.file.File value) {
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      ImageFromVideoCamera other = (ImageFromVideoCamera) obj;
      if (value == null) {
        if (other.value != null)
          return false;
