...
public final class ProgramsIndices implements Serializable {
  ...
  private fr.inria.phoenix.diasuite.framework.datatype.tvschedule.TvSchedule filter;
  
  public fr.inria.phoenix.diasuite.framework.datatype.tvschedule.TvSchedule filter() {
  	return filter;
  }
  
  public void setFilter(fr.inria.phoenix.diasuite.framework.datatype.tvschedule.TvSchedule filter) {
  	this.filter = filter;
  }
