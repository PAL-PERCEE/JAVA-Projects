...
public final class StatusFromDimmableLight implements Serializable {
  ...
  public StatusFromDimmableLight(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromDimmableLight other = (StatusFromDimmableLight) obj;
      if (value == null) {
        if (other.value != null)
          return false;
