...
public abstract class AbstractMailer extends Service {
    ...
    public AbstractMailer(ServiceConfiguration serviceConfiguration , java.lang.String id) {
      super("/Device/Device/Service/CommunicationService/Mailer/", serviceConfiguration);
      updateId(id);
    }
