...
public final class StatusFromThermostat implements Serializable {
  ...
  public StatusFromThermostat(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromThermostat other = (StatusFromThermostat) obj;
      if (value == null) {
        if (other.value != null)
          return false;
