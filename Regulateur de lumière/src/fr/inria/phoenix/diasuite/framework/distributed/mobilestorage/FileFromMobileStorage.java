...
public final class FileFromMobileStorage implements Serializable {
  ...
  public FileFromMobileStorage(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.file.File value, fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    this.sender = new MobileStorageProxy(service, remoteServiceInfo);
    this.value = value;
