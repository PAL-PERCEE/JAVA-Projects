...
public abstract class AbstractSMSSender extends Service {
    ...
    public AbstractSMSSender(ServiceConfiguration serviceConfiguration , java.lang.String id) {
      super("/Device/Device/Service/CommunicationService/SMSSender/", serviceConfiguration);
      updateId(id);
    }
