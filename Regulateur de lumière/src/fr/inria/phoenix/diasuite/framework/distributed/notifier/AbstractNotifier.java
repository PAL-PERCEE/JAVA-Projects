package fr.inria.phoenix.diasuite.framework.distributed.notifier;
...
public abstract class AbstractNotifier extends Service {
    ...
    public AbstractNotifier(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Notifier/", serviceConfiguration);
      updateId(id);
