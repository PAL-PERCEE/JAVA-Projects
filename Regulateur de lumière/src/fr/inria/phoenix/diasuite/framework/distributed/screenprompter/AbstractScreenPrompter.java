 ...
 * }
 */
public abstract class AbstractScreenPrompter extends Service {

    public AbstractScreenPrompter(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Prompter/ScreenPrompter/", serviceConfiguration);
      updateId(id);
