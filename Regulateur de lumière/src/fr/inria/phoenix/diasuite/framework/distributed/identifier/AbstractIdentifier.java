 ...
 * }
 */
public abstract class AbstractIdentifier extends Service {

    public AbstractIdentifier(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Identifier/", serviceConfiguration);
      updateId(id);
