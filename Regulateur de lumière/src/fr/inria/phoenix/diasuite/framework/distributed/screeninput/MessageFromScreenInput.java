package fr.inria.phoenix.diasuite.framework.distributed.screeninput;
...
public final class MessageFromScreenInput implements Serializable {
  ...
  public MessageFromScreenInput(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value) {
    this.sender = new ScreenInputProxy(service, remoteServiceInfo);
    this.value = value;
  }
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      MessageFromScreenInput other = (MessageFromScreenInput) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private ScreenInputProxy sender;
  
  public ScreenInputProxy sender() {
    return sender;
  }

  public class ScreenInputProxy extends Proxy {
    private ScreenInputProxy(Service service, RemoteServiceInfo remoteServiceInfo) {
