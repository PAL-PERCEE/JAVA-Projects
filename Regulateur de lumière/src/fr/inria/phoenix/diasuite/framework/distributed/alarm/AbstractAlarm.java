...
public abstract class AbstractAlarm extends Service {
    ...
    public AbstractAlarm(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Appliance/Alarm/", serviceConfiguration);
      updateId(id);
