...
public abstract class AbstractSmartTv extends Service {
    ...
    public AbstractSmartTv(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
  ...
  public final Object orderCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        if (orderName.equals("volumeUp")) {
          ...
          volumeDown();
          return null;
        } else     if (orderName.equals("pause")) {
          pause();
          return null;
        } else     if (orderName.equals("stop")) {
          stop();
          return null;
