...
public final class FileFromLocalStorage implements Serializable {
  ...
  public FileFromLocalStorage(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.file.File value, fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    this.sender = new LocalStorageProxy(service, remoteServiceInfo);
    this.value = value;
