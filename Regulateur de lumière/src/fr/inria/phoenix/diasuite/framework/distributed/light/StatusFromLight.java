package fr.inria.phoenix.diasuite.framework.distributed.light;
...
public final class StatusFromLight implements Serializable {
  ...
  public StatusFromLight(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    this.sender = new LightProxy(service, remoteServiceInfo);
    this.value = value;
  }
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromLight other = (StatusFromLight) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private LightProxy sender;
  
  public LightProxy sender() {
    return sender;
  }

  public class LightProxy extends Proxy {
