package fr.inria.phoenix.diasuite.framework.distributed.rfididentifier;
...
public final class PresentFromRfidIdentifier implements Serializable {
  ...
  public PresentFromRfidIdentifier(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value, java.lang.String id) {
    this.sender = new RfidIdentifierProxy(service, remoteServiceInfo);
    this.value = value;
