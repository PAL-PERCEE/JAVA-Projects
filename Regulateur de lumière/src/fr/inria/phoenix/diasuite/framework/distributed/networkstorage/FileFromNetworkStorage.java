...
public final class FileFromNetworkStorage implements Serializable {
  ...
  public FileFromNetworkStorage(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.file.File value, fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    this.sender = new NetworkStorageProxy(service, remoteServiceInfo);
    this.value = value;
