package fr.inria.phoenix.diasuite.framework.distributed.fan;
...
public final class StatusFromFan implements Serializable {
  ...
  public StatusFromFan(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    this.sender = new FanProxy(service, remoteServiceInfo);
    this.value = value;
  }
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromFan other = (StatusFromFan) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private FanProxy sender;
  
  public FanProxy sender() {
    return sender;
  }

  public class FanProxy extends Proxy {
    private FanProxy(Service service, RemoteServiceInfo remoteServiceInfo) {
