...
public final class TiltAngleFromPTZVideoCamera implements Serializable {
  ...
  public TiltAngleFromPTZVideoCamera(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Float value) {
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      TiltAngleFromPTZVideoCamera other = (TiltAngleFromPTZVideoCamera) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  public class PTZVideoCameraProxy extends Proxy {
    ...
    public void subscribeTiltAngle() {
      getService().getProcessor().subscribeValue(getService().getOutProperties(), new fr.inria.diagen.core.service.filter.SubscriptionFilter(this.getRemoteServiceInfo()), "tiltAngle");
    }

    public void unsubscribeTiltAngle() {
      getService().getProcessor().unsubscribeValue(getService().getOutProperties(), new fr.inria.diagen.core.service.filter.SubscriptionFilter(this.getRemoteServiceInfo()), "tiltAngle");
    }
  }
