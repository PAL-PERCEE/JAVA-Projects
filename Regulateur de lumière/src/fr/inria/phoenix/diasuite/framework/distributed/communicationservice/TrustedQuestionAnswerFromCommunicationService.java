...
public final class TrustedQuestionAnswerFromCommunicationService implements Serializable {
  ...
  public TrustedQuestionAnswerFromCommunicationService(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, java.lang.String questionId) {
    this.sender = new CommunicationServiceProxy(service, remoteServiceInfo);
    this.value = value;
