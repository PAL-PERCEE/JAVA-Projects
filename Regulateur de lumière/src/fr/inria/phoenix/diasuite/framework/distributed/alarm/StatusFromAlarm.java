package fr.inria.phoenix.diasuite.framework.distributed.alarm;
...
public final class StatusFromAlarm implements Serializable {
  ...
  public StatusFromAlarm(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromAlarm other = (StatusFromAlarm) obj;
      if (value == null) {
        if (other.value != null)
          return false;
