...
public final class QuestionAnswerFromInstantMessenger implements Serializable {
  ...
  public QuestionAnswerFromInstantMessenger(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, QuestionAnswerIndices indices) {
    this.sender = new InstantMessengerProxy(service, remoteServiceInfo);
    this.value = value;
    this.indices = indices;
  }
  
  public QuestionAnswerFromInstantMessenger(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, java.lang.String questionId) {
    this.sender = new InstantMessengerProxy(service, remoteServiceInfo);
    this.value = value;
  ...
  public QuestionAnswerIndices indices(){
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      QuestionAnswerFromInstantMessenger other = (QuestionAnswerFromInstantMessenger) obj;
      if (value == null) {
        if (other.value != null)
          return false;
