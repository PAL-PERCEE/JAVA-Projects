package fr.inria.phoenix.diasuite.framework.distributed.heater;
...
public final class StatusFromHeater implements Serializable {
  ...
  public StatusFromHeater(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.onoffstatus.OnOffStatus value) {
    this.sender = new HeaterProxy(service, remoteServiceInfo);
    this.value = value;
  }
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      StatusFromHeater other = (StatusFromHeater) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private HeaterProxy sender;
  
  public HeaterProxy sender() {
    return sender;
  }

  public class HeaterProxy extends Proxy {
    private HeaterProxy(Service service, RemoteServiceInfo remoteServiceInfo) {
