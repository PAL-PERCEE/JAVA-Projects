 ...
 * }
 */
public abstract class AbstractMobileStorage extends Service {

    public AbstractMobileStorage(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user, java.lang.String name) {
      super("/Device/Device/PhysicalDevice/Storage/MobileStorage/", serviceConfiguration);
      updateId(id);
