 ...
 * }
 */
public abstract class AbstractButton extends Service {

    public AbstractButton(ServiceConfiguration serviceConfiguration , java.lang.String id, java.lang.String location, java.lang.String user) {
      super("/Device/Device/PhysicalDevice/Button/", serviceConfiguration);
      updateId(id);
  ...
  protected final void internalPostInitialize() {postInitialize();}
        ...
        private java.lang.Boolean _pushed;
        /**
         * @[480,1]
         * source pushed as Boolean;
         */  
        protected void publishPushed(java.lang.Boolean newPushedValue ) {
          _pushed = newPushedValue;
          getProcessor().publishValue(getOutProperties(), "pushed", newPushedValue); 
        }
