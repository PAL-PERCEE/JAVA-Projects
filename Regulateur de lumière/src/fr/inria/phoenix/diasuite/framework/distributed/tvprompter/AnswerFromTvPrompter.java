...
public final class AnswerFromTvPrompter implements Serializable {
  ...
  public AnswerFromTvPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, AnswerIndices indices) {
    this.sender = new TvPrompterProxy(service, remoteServiceInfo);
    this.value = value;
    this.indices = indices;
  }
  
  public AnswerFromTvPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value, java.lang.String questionId) {
    this.sender = new TvPrompterProxy(service, remoteServiceInfo);
    this.value = value;
  ...
  public AnswerIndices indices(){
    ...
    public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      AnswerFromTvPrompter other = (AnswerFromTvPrompter) obj;
      if (value == null) {
        if (other.value != null)
          return false;
  ...
  private TvPrompterProxy sender;
  
  public TvPrompterProxy sender() {
    return sender;
  }

  public class TvPrompterProxy extends Proxy {
    private TvPrompterProxy(Service service, RemoteServiceInfo remoteServiceInfo) {
